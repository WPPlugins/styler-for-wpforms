<?php
$wp_customize->add_section( 'sfwf_select_form_section' , array(
    'title' => 'Select WPForm',
    'panel' => 'sfwf_panel',
  ) );

$wp_customize->add_setting( 'sfwf_select_form_id' , array(
    'default'     => '-1',
...
$wp_customize->add_control( 'sfwf_select_form_id', array(
    'type' => 'select',
